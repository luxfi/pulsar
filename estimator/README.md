...
Pulsar-M parameter set, generated by Albrecht et al.'s lattice-estimator
...
Pulsar-M parameter sets:
- `Pulsar-M-44` → required tier
- `Pulsar-M-65` → suggested tier (default for Hanzo / Lux)
- `Pulsar-M-87` → highest NIST PQ Cat 5
...
- [ ] First estimator run on Pulsar-M-65
