...
The Shamir secret-sharing layer of Pulsar operates orthogonally to
...
\begin{theorem}[Pulsar scales information-theoretically in $n$]
\label{thm:pulsar-scales-it}
Fix a Pulsar parameter level $L \in \{44, 65, 87\}$. For every
