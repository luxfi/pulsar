...
\textbf{Annulus} (code-name \texttt{Nasua}; tracks academic Corona upstream) &
...
Corona primitive of Boschini et~al.~\cite{boschini2024corona},
...
upstream-tracker from the academic Corona primitive itself.
\end{itemize}
