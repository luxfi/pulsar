...
\midrule
\textbf{Pulsar} (was Pulsar.M / pulsar) &
...
of Boschini et~al.~\cite{boschini2024corona}, which builds on
...
\begin{itemize}[leftmargin=*, itemsep=0pt]
\item Do not write ``Pulsar.M'' or ``Pulsar'' in new prose; both
...
\item[$\boxtimes$] Pulsar.M repo bootstrap (\texttt{pulsar/})
