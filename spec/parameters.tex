% Pulsar-M concrete parameter sets — included by pulsar-m.tex §"Concrete parameters"
...
% finalized; the Pulsar-M parameter table is structurally identical to
...
statistical $\geq 40$ bits. Pulsar-M-44 satisfies this.
...
$\geq 64$ bits. Pulsar-M-65 satisfies this.

Pulsar-M-87 covers the highest NIST PQ category for completeness.
