...
\paragraph{Boschini et al construction \cite{boschini2024corona}.}
Pulsar (and therefore Pulsar-M) is a fork of the R-LWE academic line.
ePrint 2024/1113 authors: Cecilia Boschini, Darya
Kaviani, Russell W. F. Lai, Giulio Malavolta, Akira Takahashi, Mehdi
Tibouchi. Corona's open-source repo is Apache-2.0 with no asserted
patent claims as of mid-2026. Pulsar-M's M-LWE adaptation does not
import Corona code directly but inherits the protocol structure.
