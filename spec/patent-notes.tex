...
This applies to Pulsar to the extent that Pulsar code or
protocol elements are derivative of Pulsar.

\paragraph{Boschini et al construction \cite{boschini2024corona}.}
Pulsar (and therefore Pulsar) is a fork of the R-LWE academic line.
...
patent claims as of mid-2026. Pulsar's M-LWE adaptation does not
