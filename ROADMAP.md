...
- KAT vectors aligned with the `./vectors/` format.
...
| Q2 2027 | KAT vectors | Generate aligned KATs in `./vectors/`-style JSON; deterministic regen via seeded RNG. |
...
| Q1 2027 | Submission acknowledgment | NIST acknowledges receipt; Lux publishes submission package mirror on `github.com/luxfi/pulsar` `Releases`. |
...
- `./INFORMATION-ARCHITECTURE.md` documents three-axis taxonomy.
- LPs 168-179 mirror Hanzo HIPs 0077-0104 for E2E PQ.
- `./SUITE.md` + `./HANZO-CRYPTO-SUITE.md` are master
  indexes.
...
11. **Open public GitHub Discussions** at `https://github.com/luxfi/pulsar/discussions`
